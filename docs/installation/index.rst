...
Ouside of production, RDMO can be installed using your regular user. In production, a dedicated user should be used. We suggest to create a user called ``rdmo`` with the group ``rdmo`` and the home directory ``/home/rdmo``. We will use this user throughout the whole documantation.
