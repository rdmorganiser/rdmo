...
const ConfirmDeleteModal = ({ show, onClose, isManager = false, isMember = false, isCurrentUser = false, person }) => {
      ...
      >
        <Html
          html={
            isCurrentUser
              ? interpolate(
                  gettext('You are about to leave the project <b>%s</b>.<br><br>If you want to access this project again, somebody will need to invite you!'),
                  [project?.title ?? '']
                )
              : isMember
              ? interpolate(
