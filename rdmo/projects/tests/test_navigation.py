...
result_map = {
    ...
    'http://example.com/terms/questions/catalog/conditions/text_less_than': (0, 0, False),
    'http://example.com/terms/questions/catalog/conditions/text_less_than_equal': (0, 0, False),
