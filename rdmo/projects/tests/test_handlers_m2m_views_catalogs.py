...
from .helpers import assert_all_projects_are_synced_with_instance_catalogs, enable_project_views_sync  # noqa: F401
...
def test_project_views_sync_when_updating_view_catalogs(settings, enable_project_views_sync):  # noqa:F811
    ...
    assert_all_projects_are_synced_with_instance_catalogs(V[1])
    ...
    assert set(P[3].views.all()) == {V[3]}
    assert_all_projects_are_synced_with_instance_catalogs(V[2])
    ...
    assert_all_projects_are_synced_with_instance_catalogs(V[3])
