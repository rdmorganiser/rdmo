...
class ProjectsConfig(AppConfig):
    ...
    def ready(self):
        ...
        if settings.PROJECT_VIEWS_SYNC:
            ...
            from .handlers.membership_changed import post_save_membership_sync_views  # noqa: F401
        ...
        if settings.PROJECT_TASKS_SYNC:
            ...
            from .handlers.membership_changed import post_save_membership_sync_tasks  # noqa: F401
            from .handlers.project_changed_catalog import (  # noqa: F401
