...
from rdmo.questions.rules import is_an_editor, is_element_reviewer
...
rules.add_perm('questions.view_questionset_object', (is_project_member | is_site_manager) | (is_an_editor | is_element_reviewer))
