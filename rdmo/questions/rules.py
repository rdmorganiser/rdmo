...
# for catalogs
rules.add_perm('questions.view_catalog', is_an_editor)
...
# for sections
rules.add_perm('questions.view_section', is_an_editor)
...
# for questionsets
rules.add_perm('questions.view_questionset', is_an_editor)
...
# for questions
rules.add_perm('questions.view_question', is_an_editor)
...
# Object permissions
# for catalogs
rules.add_perm('questions.view_catalog_object', is_an_editor)
...
# for sections
rules.add_perm('questions.view_section_object', is_an_editor)
...
# for questions
rules.add_perm('questions.view_question_object', is_an_editor)
