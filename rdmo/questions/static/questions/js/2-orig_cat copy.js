    ...
    service.init = function() {
        ...
        service.sites.$promise.then(
            ...
            if (service.filterCatalogsCurrentSite && sites.length > 1) {
                ...
                service.catalog_query = {list_action: 'index'};
            }
            return resources.catalogs.query(service.catalog_query).$promise
        })
        .then(function(response) {
            // resources.catalogs.query(service.catalog_query, 
            service.catalogs = response;
            console.log(service.catalog_query, response);
