# Generated by Django 4.2.24 on 2025-09-30 08:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('python_path', models.CharField(help_text="Python dotted path to the plugin class, e.g. 'rdmo_specific_plugin.module.PluginClass'", max_length=512, verbose_name='Python path')),
                ('plugin_type', models.CharField(choices=[('export', 'Project export'), ('snapshot_export', 'Snapshot export'), ('import', 'Project import'), ('optionset_provider', 'Optionset provider'), ('issue_provider', 'Issue provider')], max_length=32)),
