...
class _CatalogsTableIndexView(ModelPermissionMixin, LoginRequiredMixin, SingleTableMixin, FormView):
    permission_required = 'questions.view_catalog'
    model = Catalog
    table_class = CatalogsTable
    form_class = CatalogsTableForm
...
class SitesListView(ModelPermissionMixin, LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['sites_list_url'] = reverse('column_sites_form', args=str(self.kwargs['pk'])) 
        return context
