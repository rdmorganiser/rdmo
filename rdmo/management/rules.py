...
rules.add_perm('sites.view_site', is_an_editor)
rules.add_perm('auth.view_group', is_an_editor)

# Model Permissions for domain
rules.add_perm('domain.view_attribute', is_an_editor)
...
rules.add_perm('options.view_option', is_an_editor)
...
rules.add_perm('options.view_optionset', is_an_editor)
...
rules.add_perm('conditions.view_condition', is_an_editor)
