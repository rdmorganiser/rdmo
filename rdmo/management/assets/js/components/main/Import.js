...
import ImportWarnings from '../import/ImportWarnings'
import {Checkbox} from '../common/Checkboxes'
import Errors from '../import/common/Errors'
  ...
  return (
      <div className="panel panel-default panel-import">
        ...
        { importWarnings.length > 0 &&
            <ImportWarnings config={config} elements={importWarnings} importActions={importActions} configActions={configActions}/>
        }
        </ul>
        <ul className="list-group">
        {
          importErrors.map((element, index) => {
