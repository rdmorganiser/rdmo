...
class Command(BaseCommand):
    ...
    models = (
        ...
        (1004, 'date', 0, None, None, 'datetime', 'date'),
        ...
        (1014, 'collection.date', 1, 1010, None, 'datetime', 'date'),
        ...
        (1104, 'set.date', 0, 1100, 1100, 'datetime', 'date'),
        ...
        (1114, 'set.collection.date', 1, 1110, 1100, 'datetime', 'date'),
        ...
        (1204, 'collection_set.date', 0, 1200, 1200, 'datetime', 'date'),
        ...
        (1214, 'collection_set.collection.date', 1, 1210, 1200, 'datetime', 'date'),
