...
urlpatterns = [
    ...
    url(_(r'^(?P<pk>[0-9]+)/summary/$'), project_answers, name='project_answers'),
    url(_(r'^(?P<pk>[0-9]+)/summary/export/(?P<format>[a-z]+)/$'), project_answers_export, name='project_answers_export'),
